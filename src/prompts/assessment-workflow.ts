      ...
      messages: [
        {
          ...
          content: {
            ...
            text: [
              ...
              '4. air_get_assessment_summary (or air_get_assessment_report with section) for triage',
              '5. If EU AI Act tier is NA: air_list_open_facts → air_submit_fact_answers → re-check tier',
              '6. Summarize key risks and remaining open facts',
            ].join('\n'),
          },
        },
      ],
